...
mobile_device_detect(true,true,true,true,"http://localhost/bb/",true,true,"http://localhost/176/");
...
<head>
 ...
 <script src="http://static.ak.connect.facebook.com/js/api_lib/v0.4/FeatureLoader.js.php" type="text/javascript"></script>
  ...
  <div id="header">
  <div id="banner">
     <h1><a href="<?=base_url(); ?>">Submit URLs</a></h1>
  </div>
  ...
  <div id="topmenu">
    <ul>
     ...
     <li> <a href="<?=base_url();?>submit">Submit New URLs</a> </li>
     <li> <a href="<?=base_url();?>top" >Top URLs</a> </li>
